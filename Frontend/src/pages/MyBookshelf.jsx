                    ...
                    <div key={book._id} className="flex bg-gray-50 border border-gray-200/80 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all">
                      ...
                      <div className="p-4 flex-1 flex flex-col justify-between">
                        ...
                        <button
                          ...
                          className="mt-3 w-full py-1.5 bg-sky-600 hover:bg-sky-700 text-white font-bold text-xs rounded-lg flex items-center justify-center gap-1 shadow-sm transition-colors"
                        >
                ...
                {completed.map((book) => (
                  <div key={book._id} className="flex bg-gray-50 border border-gray-200/80 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all opacity-85">
                    ...
                    <div className="p-4 flex-1 flex flex-col justify-between">
                      ...
                      <div className="mt-3 text-emerald-600 font-extrabold text-xs flex items-center gap-1">
                        <CheckCircle className="w-4 h-4" /> You've read this book!
                      </div>
                    </div>
                  </div>
                ))}
